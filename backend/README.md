...
## Project Structure
    ...
    ├── testapiautoconnecto_64271  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_64271`
...
2. Clone this repo and `cd testapiautoconnecto_64271`
